...
import (
	...
	"github.com/bubblemelon/my-pet-go/plant-keeper/api"
...
func main() {
	...
	// confirm that connection can be made, see on $redis-cli monitor
	c.Do("PING")
...
// list all available plant as names in "/plant-list"
